...
###На основі отриманих результатів, можна впевнено сказати, що модель вийшла робочою, але далеко не ідеальною, і її точність виявилася нижчою, ніж хотілося б для реального використання.Головна проблема полягає в тому, що коефіцієнт детермінації становить R2 0.60. Це означає, що модель змогла вловити й пояснити лише 60% факторів, які насправді впливають на розмір зарплати, а решта 40% закономірностей просто залишилися поза її увагою. При цьому середня відносна помилка прогнозування (Validation MAPE) тримається на цілком адекватному рівні 9.06%###
